...
function wpjam_qiniutek_get_option_labels(){
	...
	$watermark_fields = array(
		'watermark'	=> array('title'=>'水印图片',		'type'=>'text',		'description'=>'水印图片'),
		'disslove'	=> array('title'=>'透明度',		'type'=>'number',	'description'=>'透明度，取值范围1-100，缺省值为100（完全不透明）','min'=>1,	'max'=>100),
		'gravity'	=> array('title'=>'水印位置',		'type'=>'select',	'options'=>$watermark_options),
	...
	$sections = array( 
    	...
    	'thumb-section'		=>array('title'=>'缩略图设置',	'fields'=>$thumb_fields,	'callback'=>'wpjam_qiniutek_thumb_section_callback',	),
    	'remote-section'	=>array('title'=>'远程图片设置',	'fields'=>$remote_fields,	'callback'=>'wpjam_qiniutek_remote_section_callback',	),
    	'watermark-section'	=>array('title'=>'水印设置',		'fields'=>$watermark_fields,'callback'=>'',	)
	);
...
function wpjam_qiniutek_validate( $wpjam_qiniutek ) {
	...
	$checkbox_keys	= wpjam_get_checkbox_settings($labels);
