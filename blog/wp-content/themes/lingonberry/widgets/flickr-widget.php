...
// Flickr widget for Lingonberry WordPress theme

class lingonberry_flickr_widget extends WP_Widget {

	function lingonberry_flickr_widget() {
		parent::WP_Widget(false, $name = 'Flickr widget', array('description' => __('Displays your latest Flickr photos.', 'lingonberry') ));	
	}
	...
	function widget($args, $instance) {
		...
		<p class="widgetmore"><a href="http://www.flickr.com/photos/<?php echo "$fli_id"; ?>"><?php _e('More on Flickr &raquo;', 'lingonberry'); ?></a></p>
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('id'); ?>"><?php _e('Flickr ID (use <a target="_blank" href="http://www.idgettr.com">idGettr</a>):', 'lingonberry'); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of images to display:', 'lingonberry'); ?>
...
register_widget('lingonberry_flickr_widget'); ?>