                        ...
                        <div id="main_content_section_magthree">
                                    ...
                                    <div id="magfour_right">
                                        ...
                                        <?php
											...
											if ( !of_get_option('magseven_catbox_id') ) {
												$cats_ids = '1';
											}else {
												$cats_ids = of_get_option('magseven_catbox_id');
											}											
                                                            ...
                                                            <?php
                                                                ...
                                                                <div class="mag_category_column_firstpost_vertical">
                                                                    <div class="mag_category_column_individual_post_vertical">
                                                                        ...
                                                                        <?php if ( function_exists('the_ratings') && (!of_get_option('show_ratings_magseven_cat') || of_get_option('show_ratings_magseven_cat') == 'true')) : ?>
                                                                ...
                                                                <div class="mag_category_column_secondpost_vertical">
                                                                    <?php 
                                                                    $postcount = of_get_option('magseven_catbox_num') -1;
                                    ...
                                    <?php while (have_posts()) : the_post(); ?>	
                                        ...
                                        <div class="magthree_left_individual_post">
                                            ...
                                            <?php if( !empty($magprorecentthumb) && ( !of_get_option('show_postthumbnail_magseven') || of_get_option('show_postthumbnail_magseven') == 'true' ) ) :?>
