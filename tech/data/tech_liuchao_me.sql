...
INSERT INTO `t_postmeta` VALUES (1,2,'_wp_page_template','default'),(2,1,'_edit_lock','1432465699:1'),(3,1,'_edit_last','1'),(6,1,'_syntaxhighlighter_encoded','1'),(9,1,'_wp_old_slug','hello-world'),(12,1,'_wp_old_slug','query-rewrite-andproxy-pass-in-fiddler'),(15,1,'_wp_old_slug','query-rewrite-and-proxy-pass-in-fiddler'),(26,1,'_oembed_563821cb90337e1ae389f354945061fa','{{unknown}}'),(27,1,'_oembed_07c0b28195213a84e15ac9d4b5be50a6','{{unknown}}'),(28,1,'_oembed_45e0797beab7ea87e0007309571baaf1','{{unknown}}'),(29,1,'_oembed_a8e67df097ee76083e0ea1f7107ea420','{{unknown}}');
...
INSERT INTO `t_posts` VALUES (1,1,'2014-06-29 09:54:54','2014-06-29 09:54:54','<blockquote><strong>问题</strong></blockquote>\r\n项目中需要前端解析出 lisp 表达式中的内容后，渲染到页面上：\r\n\r\n[javascript]\r\n(or\r\n  (==\r\n    (latest &quot;template:zebra_status&quot; &quot;#1&quot;)\r\n    1\r\n  )\r\n  (==\r\n    (latest &quot;template:ospfd_status&quot; &quot;#1&quot;)\r\n    1\r\n  )\r\n  (==\r\n    (latest &quot;template:keepalived_status&quot; &quot;#1&quot;)\r\n    1\r\n  )\r\n)\r\n[/javascript]\r\n\r\n<blockquote><strong>解决</strong></blockquote>\r\n同事离职前实现了一版，思路是使用正则表达式捕获住对应的内容，缺点也是显而易见的：不够灵活。我参考了 <a href=\"http://norvig.com/lispy.html\" target=\"_blank\">(How to Write a (Lisp) Interpreter (in Python))</a> 中的实现，完成了一版 javascript 的实现。\r\n\r\n函数 tokenize 用于将字符串预处理成统一的形式：\r\n\r\n[javascript]\r\nfunction tokenize(lisp_str) {\r\n    // 表达式中的双引号也需要被初始化成()\r\n    var index = 0,\r\n        q = [\'(\', \')\'],\r\n        pre_token = lisp_str.replace(/&quot;/g, function() {\r\n            var ret = q[index];\r\n            index = 1 - index;\r\n            return ret;\r\n        });\r\n\r\n    // &quot;(&quot;之后和&quot;)&quot;之前需要添加空格，然后再split\r\n    return pre_token.replace(/\\(/g, &quot;( &quot;)\r\n                    .replace(/\\)/g, &quot; )&quot;)\r\n                    .split(&quot; &quot;);\r\n}\r\n[/javascript]\r\n\r\n函数 read_from_tokens 负责将字符串解析成对应的数据：\r\n\r\n[javascript]\r\nfunction read_from_tokens(tokens) {\r\n    if (tokens.length == 0) {\r\n        throw &quot;unexpected EOF while reading&quot;;\r\n    }\r\n    token = tokens.shift();\r\n    if (token == &quot;(&quot;) {\r\n        var L = [];\r\n        while(tokens[0] != \')\') {\r\n            L.push(read_from_tokens(tokens));\r\n        }\r\n        tokens.shift();\r\n        return L;\r\n    }\r\n    else if (token == &quot;)&quot;) {\r\n        throw &quot;unexpected )&quot;;\r\n    }\r\n    else {\r\n        return atom(token);\r\n    }\r\n}\r\n[/javascript]\r\n\r\n工具函数 atom 负责处理变量类型相关的工作：\r\n\r\n[javascript]\r\nfunction atom(token) {\r\n    if (Number(token)===token &amp;&amp; token%1===0) {\r\n        return parseInt(token);\r\n    }\r\n    else if (token===Number(token) &amp;&amp; token%1!==0) {\r\n        return parseFloat(token);\r\n    }\r\n    else {\r\n        return token;\r\n    }\r\n}\r\n[/javascript]\r\n\r\n看下效果，还不错：\r\n\r\n<img class=\"alignleft\" src=\"https://ahr35a-ch3301.files.1drv.com/y2p8g9AtylQdblqT_NsKBfHWAfCxZKwxN0PGwcrIVpkvNuBUFAaVn6iyfYtK61RPf-KchcWt7T9SYLNTdAqYiWrVlyZHQWQ5goOeLUZ-xIGkZa8kBnVDvJsKgHlWF1eItBDFrAwVwzcf1Ht9FLeLLH3TXBK8d8WC1aEtZsXsiBAUSg/a-lisp-interpreter-in-javascript.png\" alt=\"a-lisp-interpreter-in-javascript\" width=\"363\" height=\"372\" />','javascript 解析 lisp 表达式','','publish','open','open','','a-lisp-interpreter-in-javascript','','','2015-05-24 19:10:37','2015-05-24 11:10:37','',0,'http://tech.liuchao.me/?p=1',0,'post','',0),(2,1,'2014-06-29 09:54:54','2014-06-29 09:54:54','这是示范页面。页面和博客文章不同，它的位置是固定的，通常会在站点导航栏显示。很多用户都创建一个“关于”页面，向访客介绍自己。例如，个人博客通常有类似这样的介绍：\n\n<blockquote>欢迎！我白天是个邮递员，晚上就是个有抱负的演员。这是我的博客。我住在天朝的帝都，有条叫做杰克的狗。</blockquote>\n\n……公司博客可以这样写：\n\n<blockquote>XYZ Doohickey公司成立于1971年，自从建立以来，我们一直向社会贡献着优秀doohicky。我们的公司总部位于天朝魔都，有着超过两千名员工，对魔都政府税收有着巨大贡献。</blockquote>\n\n您可以访问<a href=\"http://tech.liuchao.me/wp-admin/\">仪表盘</a>，删除本页面，然后添加您自己的内容。祝您使用愉快！','示例页面','','publish','open','open','','sample-page','','','2014-06-29 09:54:54','2014-06-29 09:54:54','',0,'http://tech.liuchao.me/?page_id=2',0,'page','',0);
...
INSERT INTO `t_slim_events` VALUES (1,0,'click',NULL,'665,647',255,1432465001);
...
INSERT INTO `t_slim_stats` VALUES (220,1875509301,0,'admin','cn',NULL,'/',NULL,'flash','user:1;',131,1411,1268,'Chrome','40',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1422780734),(221,1008472782,0,NULL,'cn',NULL,'/wp-login.php?redirect_to=http://tech.liuchao.me/wp-admin/index.php&reauth=1',NULL,'flash',NULL,132,326,816,'Chrome','40',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36',NULL,9812,9812,'login',NULL,NULL,0,NULL,1423402853),(222,1246220762,0,NULL,'us','http://liuchao.me/','/',NULL,'acrobat,flash,quicktime,silverlight',NULL,133,299,1000,'Chrome','39',0,'win7','en-us','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.99 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1424065958),(223,846466448,0,NULL,'us','http://www.liuchao.me/','/',NULL,'acrobat,flash',NULL,134,3505,1945,'Chrome','40',0,'macosx','en-us','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1425116576),(224,846466448,0,NULL,'us','http://tech.liuchao.me/','/',NULL,'acrobat,flash',NULL,134,3,104,'Chrome','40',0,'macosx','en-us','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1425116601),(225,1195920956,0,NULL,'us','http://liuchao.me/','/',NULL,'acrobat,flash',NULL,135,431,907,'Chrome','40',0,'macosx','en-us','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1425355696),(226,1195920956,0,NULL,'us','http://tech.liuchao.me/','/2014/06/query-rewrite-and-proxy-pass-in-fiddler/',NULL,'acrobat,flash',NULL,135,820,1346,'Chrome','40',0,'macosx','en-us','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36',NULL,9812,9812,'post','3,5','admin',1,NULL,1425355708),(227,1195920956,0,NULL,'us','http://tech.liuchao.me/2014/06/query-rewrite-and-proxy-pass-in-fiddler/','/',NULL,'acrobat,flash',NULL,135,2,64,'Chrome','40',0,'macosx','en-us','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1425355708),(228,1195920956,0,NULL,'us','http://tech.liuchao.me/','/sample-page/',NULL,'acrobat,flash',NULL,135,385,516,'Chrome','40',0,'macosx','en-us','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36',NULL,9812,9812,'page',NULL,'admin',2,NULL,1425355710),(229,1195920956,0,NULL,'us','http://tech.liuchao.me/sample-page/','/wp-login.php?redirect_to=http://tech.liuchao.me/wp-admin/&reauth=1',NULL,'acrobat,flash',NULL,135,484,816,'Chrome','40',0,'macosx','en-us','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36',NULL,9812,9812,'login',NULL,NULL,0,NULL,1425355738),(230,1195920956,0,NULL,'us','http://tech.liuchao.me/','/sample-page/',NULL,'acrobat,flash',NULL,135,2,109,'Chrome','40',0,'macosx','en-us','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36',NULL,9812,9812,'page',NULL,'admin',2,NULL,1425355739),(231,1195920956,0,NULL,'us','http://tech.liuchao.me/2014/06/query-rewrite-and-proxy-pass-in-fiddler/','/',NULL,'acrobat,flash',NULL,135,2,99,'Chrome','40',0,'macosx','en-us','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1425355740),(232,1195920956,0,NULL,'us','http://tech.liuchao.me/','/2014/06/query-rewrite-and-proxy-pass-in-fiddler/',NULL,'acrobat,flash',NULL,135,3,176,'Chrome','40',0,'macosx','en-us','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36',NULL,9812,9812,'post','3,5','admin',1,NULL,1425355741),(233,1195920956,0,NULL,'us','http://liuchao.me/','/',NULL,'acrobat,flash',NULL,135,3,101,'Chrome','40',0,'macosx','en-us','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1425355742),(234,1885005629,0,NULL,'cn','http://liuchao.me/','/',NULL,'flash,mediaplayer,silverlight',NULL,136,123,1333,'Chrome','31',0,'win8','zh-cn','Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.63 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1425971551),(235,2026323058,0,NULL,'cn','http://www.baidu.com/link?url=OKzuhjSevMSDwXCnRAr-dSdol3yrOzbF0LTrI4jZt33W0OzXLy4hzMx2vwcEhTAo&wd=toolsmatter&issp=1&f=8&ie=utf-8&tn=baiduhome_pg&inputT=5584','/','toolsmatter','flash,quicktime',NULL,137,117,2975,'Safari','8',0,'macosx','en-us','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/600.4.10 (KHTML, like Gecko) Version/8.0.4 Safari/600.4.10',NULL,9812,9812,'home',NULL,NULL,0,NULL,1427111923),(236,989167000,0,NULL,'cn','http://liuchao.me/','/',NULL,'flash',NULL,138,241,952,'Chrome','40',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1427722405),(237,1109738123,0,NULL,'us','http://liuchao.me/','/',NULL,'flash',NULL,139,251,888,'Chrome','41',0,'win8.1','en-us','Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.101 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1427952343),(238,3722365984,0,NULL,'cn','http://liuchao.me/','/',NULL,'flash',NULL,140,174,2728,'Chrome','41',0,'macosx','zh-cn','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.101 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1427978196),(239,1928819566,0,NULL,'cn','http://liuchao.me/','/',NULL,'flash',NULL,141,135,1187,'Chrome','41',0,'win8.1','zh-cn','Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.101 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1429713451),(240,1928819566,0,NULL,'cn','http://tech.liuchao.me/','/sample-page/',NULL,'flash',NULL,141,259,863,'Chrome','41',0,'win8.1','zh-cn','Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.101 Safari/537.36',NULL,9812,9812,'page',NULL,'admin',2,NULL,1429713468),(241,1928819566,0,NULL,'cn','http://tech.liuchao.me/sample-page/','/',NULL,'flash',NULL,141,14,174,'Chrome','41',0,'win8.1','zh-cn','Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.101 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1429713500),(242,1928819566,0,NULL,'cn','http://tech.liuchao.me/','/sample-page/',NULL,'flash',NULL,141,165,598,'Chrome','41',0,'win8.1','zh-cn','Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.101 Safari/537.36',NULL,9812,9812,'page',NULL,'admin',2,NULL,1429713503),(243,1928819566,0,NULL,'cn','http://tech.liuchao.me/sample-page/','/',NULL,'flash',NULL,141,6,158,'Chrome','41',0,'win8.1','zh-cn','Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.101 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1429713504),(244,1928819566,0,NULL,'cn','http://tech.liuchao.me/','/sample-page/',NULL,'flash',NULL,141,21,676,'Chrome','41',0,'win8.1','zh-cn','Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.101 Safari/537.36',NULL,9812,9812,'page',NULL,'admin',2,NULL,1429713509),(245,1928819566,0,NULL,'cn','http://tech.liuchao.me/sample-page/','/',NULL,'flash',NULL,141,9,151,'Chrome','41',0,'win8.1','zh-cn','Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.101 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1429713509),(246,1928819566,0,NULL,'cn','http://tech.liuchao.me/','/sample-page/',NULL,'flash',NULL,141,7,654,'Chrome','41',0,'win8.1','zh-cn','Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.101 Safari/537.36',NULL,9812,9812,'page',NULL,'admin',2,NULL,1429713511),(247,1928819566,0,NULL,'cn','http://liuchao.me/','/',NULL,'flash',NULL,141,8,160,'Chrome','41',0,'win8.1','zh-cn','Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.101 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1429713511),(248,1928819566,0,NULL,'cn','http://liuchao.me/','/',NULL,'flash',NULL,141,7,167,'Chrome','41',0,'win8.1','zh-cn','Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.101 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1429713527),(249,1032310723,0,NULL,'cn','http://liuchao.me/','/',NULL,'flash,silverlight',NULL,142,197,21292,'Chrome','40',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36',NULL,9812,9812,'home',NULL,NULL,0,NULL,1429867810),(250,1032310723,0,'admin','xx','http://tech.liuchao.me/','/',NULL,'flash','user:1',143,2304,797,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'home',NULL,NULL,0,NULL,1432317464),(251,1032310723,0,'admin','xx','http://tech.liuchao.me/','/',NULL,'flash','user:1',143,1321,786,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'home',NULL,NULL,0,NULL,1432317469),(252,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/update-core.php','/',NULL,'flash','user:1',144,378,572,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'home',NULL,NULL,0,NULL,1432463965),(253,1875776537,0,'admin','xx','http://tech.liuchao.me/','/2014/06/query-rewrite-and-proxy-pass-in-fiddler/',NULL,'flash','user:1',144,467,995,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','3,5','admin',1,NULL,1432464188),(254,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/post.php?post=1&action=edit','/',NULL,'flash','user:1',144,362,284,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'home',NULL,NULL,0,NULL,1432464836),(255,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/post.php?post=1&action=edit','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',144,368,631,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','3,5','admin',1,NULL,1432464983),(256,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/post.php?post=1&action=edit','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',144,307,398,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','3,5','admin',1,NULL,1432465096),(257,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/post.php?post=1&action=edit','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',144,289,406,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','3,5','admin',1,NULL,1432465438),(258,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/post.php?post=1&action=edit','/2014/06/a-lisp-interpreter-in-javascript/?preview=true&preview_id=1&preview_nonce=ba92278cd5&post_format=standard',NULL,'flash','user:1',144,431,292,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','3,5','admin',1,NULL,1432465584),(259,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/post.php?post=1&action=edit','/2014/06/a-lisp-interpreter-in-javascript/?preview=true&preview_id=1&preview_nonce=ba92278cd5&post_format=standard',NULL,'flash','user:1',144,352,319,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','3,5','admin',1,NULL,1432465631),(260,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/post.php?post=1&action=edit','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',144,294,427,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,5','admin',1,NULL,1432465648),(261,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/post.php?post=1&action=edit','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',145,314,1662,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,5','admin',1,NULL,1432466018),(262,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/post.php?post=1&action=edit','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',145,308,1561,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,5','admin',1,NULL,1432466737),(263,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/post.php?post=1&action=edit','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',145,302,698,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,5','admin',1,NULL,1432467080),(264,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/post.php?post=1&action=edit','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',145,315,675,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,5','admin',1,NULL,1432467262),(265,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/post.php?post=1&action=edit','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',145,369,626,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,5','admin',1,NULL,1432467292),(266,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/admin.php?page=WP-Optimize','/',NULL,'flash','user:1',145,362,181,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'home',NULL,NULL,0,NULL,1432467442),(267,1875776537,0,'admin','xx','http://tech.liuchao.me/','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',145,295,284,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,5','admin',1,NULL,1432467446),(268,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/edit-comments.php?comment_status=trash&paged=1','/',NULL,'flash','user:1',145,325,140,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'home',NULL,NULL,0,NULL,1432467504),(269,1875776537,0,'admin','xx','http://tech.liuchao.me/','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',145,291,291,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,5','admin',1,NULL,1432467510),(270,1875776537,0,'admin','xx','http://tech.liuchao.me/','/',NULL,'flash','user:1',146,254,662,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'home',NULL,NULL,0,NULL,1432468295),(271,1875776537,0,'admin','xx','http://tech.liuchao.me/','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',146,319,300,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,5','admin',1,NULL,1432468299),(272,1875776537,0,'admin','xx','http://tech.liuchao.me/','/',NULL,'flash','user:1',147,249,674,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'home',NULL,NULL,0,NULL,1432471942),(273,1875776537,0,'admin','xx','http://tech.liuchao.me/','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',147,354,319,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,5','admin',1,NULL,1432471944),(274,1875776537,0,'admin','xx','http://tech.liuchao.me/','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',147,25,210,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,5','admin',1,NULL,1432472001),(275,1875776537,0,'admin','xx','http://tech.liuchao.me/','/',NULL,'flash','user:1',148,278,316,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'home',NULL,NULL,0,NULL,1432492865),(276,1875776537,0,'admin','xx','http://tech.liuchao.me/','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',148,582,238,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,5','admin',1,NULL,1432492872),(277,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/options-general.php?page=jiathis-share.php','/',NULL,'flash','user:1',148,414,105,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'home',NULL,NULL,0,NULL,1432493093),(278,1875776537,0,'admin','xx','http://tech.liuchao.me/','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',148,266,287,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,5','admin',1,NULL,1432493094),(279,1875776537,0,'admin','xx','http://tech.liuchao.me/','/',NULL,'flash','user:1',148,277,325,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'home',NULL,NULL,0,NULL,1432493294),(280,1875776537,0,'admin','xx','http://tech.liuchao.me/','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',148,284,272,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,5','admin',1,NULL,1432493298),(281,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/options-general.php?page=jiathis-share.php','/',NULL,'flash','user:1',148,348,115,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'home',NULL,NULL,0,NULL,1432493318),(282,1875776537,0,'admin','xx','http://tech.liuchao.me/','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',148,326,413,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,5','admin',1,NULL,1432493320),(283,1875776537,0,'admin','xx','http://tech.liuchao.me/','/',NULL,'flash','user:1',148,2097,412,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'home',NULL,NULL,0,NULL,1432494538),(284,1875776537,0,'admin','xx','http://tech.liuchao.me/','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',148,353,296,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,5','admin',1,NULL,1432494565),(285,1875776537,0,'admin','xx','http://tech.liuchao.me/wp-admin/post.php?post=1&action=edit','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',148,498,981,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,7,8','admin',1,NULL,1432494644),(286,1875776537,0,'admin','xx','http://tech.liuchao.me/2014/06/a-lisp-interpreter-in-javascript/','/2014/06/a-lisp-interpreter-in-javascript/',NULL,'flash','user:1',148,297,273,'Chrome','42',0,'win7','zh-cn','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36','1600x789',1600,900,'post','6,7,8','admin',1,NULL,1432494646);
...
INSERT INTO `t_term_relationships` VALUES (1,6,0),(1,7,0),(1,8,0);
...
INSERT INTO `t_term_taxonomy` VALUES (1,1,'category','',0,0),(2,2,'category','',0,0),(3,3,'category','',0,0),(4,4,'post_format','',0,0),(5,5,'post_tag','',0,0),(6,6,'category','',0,1),(7,7,'post_tag','',0,1),(8,8,'post_tag','',0,1);
...
INSERT INTO `t_terms` VALUES (1,'未分类','uncategorized',0),(2,'HTTP','http',0),(3,'Tools','tools',0),(4,'post-format-aside','post-format-aside',0),(5,'fiddler','fiddler',0),(6,'javascript','javascript',0),(7,'javascript','javascript',0),(8,'lisp','lisp',0);
...
INSERT INTO `t_usermeta` VALUES (1,1,'first_name',''),(2,1,'last_name',''),(3,1,'nickname','admin'),(4,1,'description',''),(5,1,'rich_editing','true'),(6,1,'comment_shortcuts','false'),(7,1,'admin_color','fresh'),(8,1,'use_ssl','0'),(9,1,'show_admin_bar_front','true'),(10,1,'t_capabilities','a:1:{s:13:\"administrator\";b:1;}'),(11,1,'t_user_level','10'),(12,1,'dismissed_wp_pointers','wp350_media,wp360_revisions,wp360_locks,wp390_widgets,wp410_dfw'),(13,1,'show_welcome_panel','0'),(14,1,'t_dashboard_quick_press_last_post_id','16'),(15,1,'t_user-settings','editor=tinymce&dfw_width=662&post_dfw=on&advImgDetails=hide'),(16,1,'t_user-settings-time','1432438619'),(17,1,'session_tokens','a:2:{s:64:\"39bb9175a4f5a04694a74874de3f84ded010dd802154a049de9f0666f56f66a9\";a:4:{s:10:\"expiration\";i:1432472252;s:2:\"ip\";s:13:\"111.206.20.31\";s:2:\"ua\";s:114:\"Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36\";s:5:\"login\";i:1431262652;}s:64:\"83eb8f09dd4597afc933108ae9fdb69791d580efebd67a5bb30a033235589005\";a:4:{s:10:\"expiration\";i:1432475796;s:2:\"ip\";s:13:\"111.206.20.31\";s:2:\"ua\";s:114:\"Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36\";s:5:\"login\";i:1431266196;}}'),(18,1,'meta-box-order_dashboard','a:4:{s:6:\"normal\";s:181:\"dashboard_right_now,dashboard_activity,slim_p1_03,slim_p1_04,slim_p1_08,slim_p1_10,slim_p1_11,slim_p1_12,slim_p1_13,slim_p2_02,slim_p2_07,slim_p2_21,slim_p3_06,slim_p4_07,slim_p4_18\";s:4:\"side\";s:39:\"dashboard_quick_press,dashboard_primary\";s:7:\"column3\";s:10:\"slim_p1_01\";s:7:\"column4\";s:0:\"\";}');
...
-- Dump completed on 2015-05-24 19:12:57
